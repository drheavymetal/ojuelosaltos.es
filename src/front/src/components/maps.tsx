// Componentes de mapa (Leaflet). Aislados en su propio módulo para cargarse por
// separado (React.lazy): así Leaflet + su CSS no entran en el bundle inicial y solo
// se descargan cuando el visitante llega a las secciones con mapa.
